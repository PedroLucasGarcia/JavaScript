...
class Avestruz extends Passaro{
  ...
  voar(){  //Polimorfismo - consiste em sobrescrever um método herdado da classe pai e alterar de acordo com a nessessidade da classe filha
...
let avestruz = new Avestruz('Médio', 'Preto e branco', 150, 1500)
